              ...
              <div v-else>
                <el-form-item v-if="ruleForm.baogaoneirong" label="报告内容" prop="baogaoneirong">
                    <span>{{ruleForm.baogaoneirong}}</span>
                                ...
                                <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'" label="改善意见" prop="gaishanyijian">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="改善意见"
                  v-model="ruleForm.gaishanyijian">
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.gaishanyijian" label="改善意见" prop="gaishanyijian">
                    <span>{{ruleForm.gaishanyijian}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
            ...
            continue;
                    ...
                    if(o=='gaishanyijian'){
            this.ruleForm.gaishanyijian = obj[o];
            continue;
          }
                    if(o=='riqi'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `yuanlinbaogao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yuanlinbaogaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
                }
              });
            } else {
