  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
                ...
                <el-input v-model="searchForm.bumen" 
                    placeholder="部门" clearable></el-input>
              </el-form-item>
                                                                                                              <el-form-item>
          <el-button round @click="search()">查询</el-button>
          <el-button
            v-if="isAuth('quyuguanlirenyuan','新增')"
            type="primary"
            @click="addOrUpdateHandler()"
            round
          >新增</el-button>
          <el-button
            v-if="isAuth('quyuguanlirenyuan','删除')"
      ...
      <div class="table-content">
        <el-table
            v-if="isAuth('quyuguanlirenyuan','查看')"
            :data="dataList"
            border
            ...
            <el-table-column
                ...
                label="操作">
                <template slot-scope="scope">
                                                <el-button v-if="isAuth('quyuguanlirenyuan','修改')" type="text" icon="el-icon-edit" size="small" @click="addOrUpdateHandler(scope.row.id)">修改</el-button>
                <el-button v-if="isAuth('quyuguanlirenyuan','删除')" type="text" icon="el-icon-delete" size="small" @click="deleteHandler(scope.row.id)">删除</el-button>
                </template>
            </el-table-column>
        </el-table>
                                                                                                                                                                <el-pagination
