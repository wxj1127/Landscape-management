          ...
          <el-form-item v-if="ruleForm.bumen" label="部门" prop="bumen">
              <el-input v-model="ruleForm.bumen" 
                placeholder="部门" readonly></el-input>
                        ...
                        <el-col :span="12">
        <el-form-item  v-if="type!='info'"  label="负责区域" prop="fuzequyu">
          <el-input v-model="ruleForm.fuzequyu" 
              placeholder="负责区域" clearable></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.fuzequyu" label="负责区域" prop="fuzequyu">
              <el-input v-model="ruleForm.fuzequyu" 
                placeholder="负责区域" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                        <el-col :span="24">  
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `quyuguanlirenyuan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.quyuguanlirenyuanCrossAddOrUpdateFlag = false;
                  this.parent.search();
                }
              });
            } else {
